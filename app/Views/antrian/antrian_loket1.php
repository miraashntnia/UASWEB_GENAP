...
<head>
    ...
    <title>Loket Pemeriksaan Oleh Dokter - Ambil Antrian</title>
</head>
...
<body>
	...
	$query = mysqli_query($databaseconn, "SELECT max(nomor_antrian) as antrianTerakhir FROM loket1");
    ...
    <div class="container clogin">
        ...
        <form action="saveantrian.php" method="post">
            ...
            <div>
                <input type="submit" value="Ambil Antrian" name="add_loket1" id="btn">
            </div>
            <?php 
			
                $barang = mysqli_query($databaseconn,"SELECT max(nomor_antrian) as antrianTerakhir FROM loket1");
