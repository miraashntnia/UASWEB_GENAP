...
<body>
	...
	$query = mysqli_query($databaseconn, "SELECT min(nomor_antrian) as antrianTerkecil FROM loket2");
    ...
    <br />
    <center>
        <h2>ANTRIAN LOKET Pembayaran</h2>
    </center>
    <div class="container clogin">
        ...
        <form action="delete.php" method="post">
            ...
            <div>
                <input type="submit" value="Selesai" name="delete_loket2" id="btn">
            </div>
            <?php 
			
                $barang = mysqli_query($databaseconn,"SELECT max(nomor_antrian) as antrianTerbesar FROM loket2");
